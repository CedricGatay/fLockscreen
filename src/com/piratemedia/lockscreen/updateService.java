...
public class updateService extends Service {
    ...
    public void onStart(Intent aIntent, int aStartId) {
        ...
        if (action.equals("com.android.music.playbackcomplete") && getPlayer() == 1) {
            ...
            bindService(new Intent().setClassName("com.tbig.playerpro", "com.tbig.playerpro.MediaPlaybackService"),
                        new ServiceConnection() {
            ...
            bindService(new Intent().setClassName("org.abrantix.rockon.rockonnggl",
